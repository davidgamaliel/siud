    ...
    public function constrainTanggalAwal ($attribute) {
        ...
        if(empty($this->waktu_mulai->params[':mulai']) || is_null($this->waktu_mulai->params[':mulai'])) {
            ...
            ";
                ...
                if(intval($count) > 0 ) {
                    $this->addError($attribute, 'Sudah terdapat peminjaman kendaraan pada waktu mulai tersebut');
                }
        }
    }
    public function constrainTanggalAkhir ($attribute) {
        ...
        else
        {
            ...
            ";
                ...
                $count = $rawData[0]['peminjaman'];
                if(intval($count) > 0 ) {
                    $this->addError($attribute, 'Sudah terdapat peminjaman kendaraan pada waktu selesai tersebut');
                }
        }
