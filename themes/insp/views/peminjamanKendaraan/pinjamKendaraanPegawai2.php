...
$('#PinjamKendaraanForm_waktu_mulai').datetimepicker({
    useCurrent: false,
    format: 'DD/MM/YYYY H:mm'
});
$('#PinjamKendaraanForm_waktu_selesai').datetimepicker({
    useCurrent: false,
    format: 'DD/MM/YYYY H:mm'
});
$('#PinjamKendaraanForm_waktu_mulai').on(\"dp.change\",function (e) {
    $('#PinjamKendaraanForm_waktu_selesai').data(\"DateTimePicker\").minDate(e.date);
});
$('#PinjamKendaraanForm_waktu_selesai').on(\"dp.change\",function (e) {
    $('#PinjamKendaraanForm_waktu_mulai').data(\"DateTimePicker\").maxDate(e.date);
});
");
?>
                    ...
                    <div class="form-horizontal">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-10">
                                ...
                                echo CHtml::dropDownList('PinjamKendaraanForm[kendaraan_id]','',$list,array('class'=>'form-control m-b'));
                                ?>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-10">
                                <?php echo $form->fileField($model,'nodin',array('class'=>'form-control')); ?><i>Upload file dalam format JPG</i>
