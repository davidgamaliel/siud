...
<div class="row wrapper border-bottom white-bg page-heading">
    <div class="col-sm-8">
        <h2>Rekap Permohonan Perbaikan Inventaris</h2>
    </div>
</div>
...
<div class="wrapper wrapper-content">
    ...
    $this->widget('ext.highcharts.HighchartsWidget', array(
        ...
        'options' => array(
            'title' => array(
                'text' => 'Grafik Permohonan Perbaikan Invetaris '. $allBulan[$bulan] . ' '. $tahun,
            ),
            'xAxis' => array(
                'text' => 'Nama Inventaris',
                'categories' => $allInventaris,
            ),
            'yAxis' => array(
            ...
            'labels' => array(
                'items' => array(
                    array(
                        'html' => 'Jumlah Permohonan Perbaikan Inventaris',
                        'style' => array(
                            'left' => '50px',
                            'top' => '18px',
                ...
                <div class="ibox-content">
                    <?php $this->widget('zii.widgets.grid.CGridView', array(
                        ...
                        'columns'=>array(
                            ...
                            array(
                                'name'=>'Nama Pemohon',
                                'value'=>'TmstUserCustom::namaPeminjamKendaraanByUserId($data["user_id"])',
                            ),
                            array(
                                'header'=>'inventaris_id',
                                'value'=>'TmstInventarisCustom::getNamaInventaris($data["inventaris_id"])',
                            ),
                            array(
